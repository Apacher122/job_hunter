// import {
//   formatOverallMatchSummary,
//   formatSuccessMetric,
// } from '../../../shared/utils/formatters/summary.formatter.js';
...
// import { MatchSummarySchema } from '../models/match_summary.models.js';
...
//     const resumeJson = await fs.promises.readFile(
//       paths.paths.jsonResume(jobPosting.companyName, jobPosting.id)
//     );
//     const coverLetterB64 = await convertPDFToBase64(
//       paths.paths.movedCoverLetter(jobPosting.companyName, jobPosting.id)
//     );
...
//       projects_section_missing_entries: hasMissingProjects,
//     } = generateMatchSummary(res);
//     const summaryFilePath = paths.paths.matchSummary(
...
//     projects_section_missing_entries,
